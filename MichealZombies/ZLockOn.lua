...
-- Settings
local lockKey = Enum.KeyCode.Z  -- Key to press for lock-on
local lockDistance = 100  -- Maximum distance to detect humanoids

-- Variables for locked humanoid
...
local function getNearestHumanoid()
    ...
    for _, obj in pairs(game.Workspace.Ignore.Zombies:GetChildren()) do
